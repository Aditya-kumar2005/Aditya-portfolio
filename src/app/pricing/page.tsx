...
const plans = [
  ...
  },
  {
    ...
    price: '$1499-$4499',
    period: 'per month',
    description: 'Go from concept to production-ready product with full development, AI integration, and deployment.',
    features: [
  ...
  },
  {
    ...
    price: 'Custom',
    period: 'pricing',
    description: 'Advanced AI, system optimization, and enterprise-grade scaling.',
    features: [
