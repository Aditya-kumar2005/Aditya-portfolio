        ...
        {isLoaded && (
          <>
            {isSignedIn ? (
              ...
              <div className="flex items-center gap-4">
                <Link href="/login" className="text-on-surface-variant hover:text-primary text-sm font-semibold transition-colors">
                    Sign In
                </Link>
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }}>
                    <Link href="/contact" className="flex items-center gap-1.5 bg-primary text-on-primary px-4 py-2 rounded-lg text-xs font-semibold uppercase tracking-widest hover:shadow-[0_0_20px_rgba(60,220,209,0.3)] transition-all duration-300 active:scale-95">
                        Let's Talk
                        <ArrowRight className="size-3.5" />
                    </Link>
                </motion.div>
                    ...
                    {isSignedIn ? (
                      ...
                      <div className="flex flex-col gap-3">
                        <Link
                            href="/login"
                            onClick={() => setMobileOpen(false)}
                            className="flex w-full items-center justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-sm font-semibold text-white/80 hover:bg-white/10 transition-all"
                        >
                            Sign In
                        </Link>
                        <Link
                            href="/contact"
                            onClick={() => setMobileOpen(false)}
                            className="flex w-full items-center justify-center gap-2 bg-primary text-on-primary px-6 py-3 rounded-lg text-sm font-semibold uppercase tracking-widest hover:shadow-[0_0_20px_rgba(60,220,209,0.3)] transition-all duration-300 active:scale-95"
                        >
                            Let's Talk
                            <ArrowRight className="size-4" />
                        </Link>
